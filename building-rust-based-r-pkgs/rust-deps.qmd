...
::: aside
Rust dependencies use [semantic versionining (semver)](https://semver.org/). The `"*"` is a shorthand for specifying the latest stable release available on crates.io.
:::
