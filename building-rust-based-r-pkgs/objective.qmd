...
In this workhop we will learn how to use extendr and create Rust-powered R package by creating a new package called `{geohash}`. The `{geohash}` R package will provide R bindings to the [geohash crate](https://docs.rs/geohash).
