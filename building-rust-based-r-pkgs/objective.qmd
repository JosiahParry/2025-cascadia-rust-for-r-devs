...
- Introduce Rust to R users
- Provide you a comprehensive view of how Rust-powered R-packages can be developed
...
- The more shared characters there are between two geohashes, the closer in physical space the geohashes are.
